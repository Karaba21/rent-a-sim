export default function Hero() {
  return (
    <section id="inicio" className="min-h-screen bg-brand-dark flex items-center pt-16">
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center py-20">
        <div>
          ...
          <h1 className="text-white text-6xl md:text-7xl font-black uppercase leading-tight">
            TU EVENTO
            <br />
        ...
        {/* Image placeholder */}
        <div className="bg-gray-800 aspect-video w-full" />
      </div>
    </section>
  );
}
